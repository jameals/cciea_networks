...
indir = here('../cciea_networks-CONFIDENTIAL/data/input')

## output directory for igraph objects
outdir_ports = here('../cciea_networks-CONFIDENTIAL/participation_vessel_ports')
# outdir_states = 'data/networks/participation_vessel_states'

## output directory for network viz
pngdir_ports = here('../cciea_networks-CONFIDENTIAL/participation_vessel_ports/plots')
# pngdir_states = 'data/networks/participation_vessel_states/plots'

## output file (including directory) for stat summaries
statdir = here('../cciea_networks-CONFIDENTIAL/results/statistics')

## directory for species group key. not confidential
processdir <- here("data/input")
```
<br>
...
We will make these network graphs for 2004-2021. 
...
```
```{r}
fishtix <- fishtix %>% filter(IOPAC %in% c("Puget Sound","North WA Coast","WA Coast","Other Coastal Washington"))
```
<br>
...
myports <- c("Puget Sound","North WA Coast","WA Coast","Other Coastal Washington")
