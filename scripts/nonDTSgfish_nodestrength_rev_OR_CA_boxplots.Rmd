...
or_fig2 <- ggplot(plotdat_or %>% filter(metric != 'Node Strength' & metric != 'Importance'), aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_or) +
...
# main landings metric plot
nca_fig2 <- ggplot(plotdat_nca %>% filter(metric != 'Node Strength' & metric != 'Importance'), aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_nca) +
...
# main landings metric plot
sca_fig2 <- ggplot(plotdat_sca %>% filter(metric != 'Node Strength' & metric != 'Importance'), aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_sca) +
...
or_rev_fig <- ggplot(or_rev_df, aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  #facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_or) +
...
nca_rev_fig <- ggplot(nca_rev_df, aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  #facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_nca) +
...
sca_rev_fig <- ggplot(sca_rev_df, aes(x=pcgroup, y=value, fill=pcgroup)) + 
  geom_boxplot(outlier.shape = NA) +
  geom_point(size = 2, alpha = 0.3,  position = position_jitter(seed = 1, width = .2)) +
  #facet_grid(rows=vars(metric), scales="free_y") +
  scale_fill_manual(values=pal_sca) +
