...
Focus on node strength only, compile into a single figure. Save plot as png, with filename: Non-DTS Groundfish Node Strength in Fisheries Participation Networks 2017-2021, Oregon and California.png
...
ns_fig_title <- ggdraw() + draw_label('Non-DTS Groundfish Node Strength in Fisheries Participation Networks\n2017-2021, Oregon and California IOPAC Port Groups', fontface='bold')

plot_grid(ns_fig_title, ns_fig, ncol=1, rel_heights=c(0.1, 1))

png(here::here(pngdir, paste0("Non-DTS Groundfish Node Strength in Fisheries Participation Networks 2017-2021, Oregon and California.png")),
...
Focus on revenue only. Compile into a single figure. Save plot as png, with filename: Non-DTS Groundfish Revenue by IOPAC Port Group 2017-2021, Oregon and California.png
...
p_rev_title <- ggdraw() + draw_label('Non-DTS Groundfish Revenue 2017-2021, Oregon and California', fontface='bold')

plot_grid(p_rev_title, p_rev, ncol=1, rel_heights=c(0.1, 1))

png(here::here(pngdir, paste0("Non-DTS Groundfish Revenue by IOPAC Port Group 2017-2021, Oregon and California.png")),
    res=200,height=1200,width=1700)
...
p_title <- ggdraw() + draw_label('Non-DTS Groundfish Node Strength in Fisheries Participation Networks and\nAggregate Revenue 2017-2021, Oregon and California IOPAC Port Groups', fontface='bold')

plot_grid(p_title, p, ncol=1, rel_heights=c(0.1, 1))

png(here::here(pngdir, paste0("Non-DTS Groundfish Node Strength in Fisheries Participation Networks and Aggregate Revenue 2017-2021, Oregon and California IOPAC Port Groups.png")),
    res=200,height=1200,width=1700)
...
p_title2 <- ggdraw() + draw_label('Non-DTS Groundfish Node Strength in Fisheries\nParticipation Networks and Aggregate Revenue 2017-2021,\n Oregon and California IOPAC Port Groups', fontface='bold')

plot_grid(p_title2, pairplot_fig, ncol=1, rel_heights=c(0.1, 1))

png(here::here(pngdir, paste0("Scatter Plot of Non-DTS Groundfish Node Strength in Fisheries Participation Networks and Aggregate Revenue 2017-2021, Oregon and California IOPAC Port Groups.png")),
...
pairplot_fig2 <- ggplot(pairplot_df, aes(x=mean_rev/10^4, y=mean_ns)) + 
  ...
  geom_text_repel(aes(label=pcgroup, colour=region), show.legend = FALSE, nudge_x = 0.5, nudge_y = 0.2, size=3, segment.colour = "grey", min.segment.length = 0.1) + #segment.colour = NA
  facet_grid(rows=vars(region),labeller = label_wrap_gen(12)) + 
  scale_colour_manual(values=pal_sca) +
  ylim(c(0,1)) +
  xlim(c(0,max_rev/10^4)) +
  labs(
...
p_title3 <- ggdraw() + draw_label('Non-DTS Groundfish\nNode Strength in Fisheries\nParticipation Networks and Aggregate\nRevenue 2017-2021, by Region\nfor IOPAC Port Groups', fontface='bold', size=12)

plot_grid(p_title3, pairplot_fig2, ncol=1, rel_heights=c(0.1, 1))

png(here::here(pngdir, paste0("Scatter Plot of Non-DTS Groundfish Node Strength in Fisheries Participation Networks and Aggregate Revenue 2017-2021, by Region for IOPAC Port Groups.png")),
    res=200, height=900,width=700)  # ,height=1400,width=1600
