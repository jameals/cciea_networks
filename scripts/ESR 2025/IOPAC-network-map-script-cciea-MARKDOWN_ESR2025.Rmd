...
CW_map <- ggdraw(box_iopac(base_map_iopac(c("washington", "oregon", "california"), c(-130, -117), c(NA, NA)), box_filter('CW'),c('WA', 'OR', 'NCA', 'SCA'))) + 
  draw_image(img_nwc, x = .24, y = .68, hjust = 0, vjust = 0, width = 0.26, height = 0.26) +
  draw_image(img_ast, x = .25, y = .46, hjust = 0, vjust = 0, width = 0.26, height = 0.26) +
  draw_image(img_fb, x = .25, y = .16, hjust = 0, vjust = 0, width = 0.26, height = 0.26) +
  draw_image(img_mb, x = .32, y = .26, hjust = 0, vjust = 1, width = 0.26, height = 0.26) 
