...
# remove duplicates (added 01-07-2025)

dat <- dat %>% distinct()
dat2 <- dat2 %>% distinct()

write.csv(dat,here::here(statdir, paste0('VesselLevelNodeStats_2004_2023_21pcgroups_totalrev5000_indivrev500_connectivity_rmCrab_10pContribution_rmdupes.csv')), row.names=FALSE)

write.csv(dat2,here::here(statdir, paste0('VesselLevelNetworkStats_2004_2023_21pcgroups_totalrev5000_indivrev500_connectivity_rmCrab_10pContribution_rmdupes.csv')), row.names=FALSE)
