...
if species groupings column is named something other than metier.name, you'll have to go through the generate_participation_network.R function to replace it
```{r}
for(y in years){
  if(y %in% ref_years){
