...
landings_metrics_scaled <- c('adjrev_scaled','adjrev_ltmean', 'pounds_scaled','pounds_ltmean')
...
p_all <- plot_grid(fig_scaled, p_2020,
                            ...
                            label_size = 16, label_x = c(0.1,0.1), label_y = c(1,1), align = "hv", rel_widths = c(1.2, 1), ncol = 2
) #label_x = 0.4, c(0.35, 0.35, 0.35, 0.35, 0.35, 0.35)
p_all
...
png(here::here(pngdir, paste0("Salmon-Based Vulnerability and 2 Example IOPAC Fisheries Participation Networks 2020-2021.png")),
    res=300,height=2100,width=2800)
p_all
dev.off()
```
