...
```{r All Fisheries Participation Networks 2020-2021, by IOPAC Port Group, fig.width = 16, fig.height = 16}
...
ggsave(here::here(pngdir_ports,'All Fisheries Participation Networks 2020-2021, by IOPAC Port Group.png'), p_all, width = 6, height = 6, dpi =600)
