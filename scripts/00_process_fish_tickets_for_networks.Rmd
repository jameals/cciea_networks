...
myfile2 <- 'fish tickets 2016-2023 121323.rds' # latest pull from PacFIN 12-13-2023
...
for(y in years){
  ...
  tmp_out <- rawdat.sub4 %>%
    ...
    dplyr::select(c(trip_id, year, tdate,agid, 
                       ...
                       drvid, drvid_year,proc, fleet, pounds, ppp, afi_ppp, adj_afi_ppp, revenue, afi_revenue, adj_afi_revenue)) # removed adj_ppp and adj_revenue 01-18-2024
  ...
  for(y in crab_years){
    ...
    tmp_out <- rawdat.sub5 %>%
      ...
      dplyr::select(c(trip_id, year, crab_year, tdate,agid, 
                       ...
                       spid, spid_recode, SPGRPN2, council,
                       grgroup, grid, removal_type,removal_type_code,
                       drvid, drvid_year,proc, fleet, pounds, afi_ppp, adj_afi_ppp, revenue, afi_revenue, adj_afi_revenue)) # removed adj_ppp and adj_revenue 01-18-2024
    ## write out
