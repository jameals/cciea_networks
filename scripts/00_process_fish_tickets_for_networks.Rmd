...
# will need to glue 2004-2018 data to 2019-2020 data
 # /Users/jameal.samhouri/Documents/Koehn et al. cc vulnerability/Data/pacfin_compiled_2004thru2018.rds
# /Users/jameal.samhouri/Documents/CCIEA Networks/fish tickets 2019-2020.csv
...
# # add fish ticket data for 2019-20, make new RDS
# 
# pacfin2017_2018.df <- as.data.table(read.csv("~/Dropbox/Projects/In progress/RAIMBOW/Samhouri et al. whales risk/Input_Data/PacFIN/Input_Data/fish tickets 2017-2018 062019.csv", header=TRUE))
# dim(pacfin2017_2018.df)
# which(names(pacfin.df) != names(pacfin2017_2018.df)) # just last 14 columns of 2017-18 data do not match
# pacfin2017_2018.df <- pacfin2017_2018.df[,1:101]
# 
# pacfin.df2 <- bind_rows(pacfin.df,pacfin2017_2018.df)
# saveRDS(pacfin.df2, "~/Dropbox/Projects/In progress/Koehn et al. cc vulnerability/Data/pacfin_compiled_thru2018.rds")
